          ...
          <div className="mx-auto max-w-7xl px-6 relative z-10 w-full">
            ...
            >
              ...
              <p className="mt-8 text-lg leading-relaxed text-white/70">
                Oferecemos soluções jurídicas de alta complexidade, com foco em resultados sólidos e
                proteção estratégica de ativos para empresas e patrimônios familiares.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid gap-16 lg:grid-cols-12 lg:items-start">
              ...
              <div className="lg:col-span-4 sticky top-32">
                <div className="space-y-4">
                  {practiceAreas.map((area) => (
                    <button
                      ...
                      className={`group relative flex w-full items-center justify-between border-b border-gold/10 p-6 text-left transition-all duration-500 md:p-8 ${
                    ...
                    >
                        ...
                        <div className="relative">
                          <p
                            className={`font-serif text-xl md:text-2xl transition-colors duration-500 ${
                              activeArea.id === area.id
                                ? "text-velvet"
                                : "text-velvet/30 group-hover:text-velvet/60"
                            }`}
                          >
                            {area.shortTitle}
                          </p>
                      ...
                      <ArrowRight
                        className={`h-5 w-5 transition-all duration-500 ${
                          activeArea.id === area.id
                            ? "translate-x-0 opacity-100 text-gold"
                            : "-translate-x-4 opacity-0 text-gold/40"
                        }`}
                      />
                    </button>
                  ))}
                ...
                <div className="mt-12 rounded-none bg-velvet p-8 text-white">
                  ...
                  <a
                    href="#contato"
                    className="mt-6 inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-gold hover:text-white transition-colors"
                  >
                  ...
                  >
                    ...
                    <div className="mt-12 grid gap-6 sm:grid-cols-2">
                      <div className="p-8 border border-gold/10 bg-cream/30">
                        <h4 className="font-serif text-lg text-velvet mb-3">
                          Consultoria Estratégica
                        </h4>
                        <p className="text-sm text-velvet/60 leading-relaxed">
                      ...
                      <div className="p-8 border border-gold/10 bg-cream/30">
                        ...
                        <p className="text-sm text-velvet/60 leading-relaxed">
                          Atuação técnica em tribunais para proteger ativos e interesses
                          operacionais.
                        </p>
                      </div>
                    </div>
