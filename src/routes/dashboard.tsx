      ...
      <aside className="hidden xl:flex w-72 bg-velvet text-white flex-col border-r border-white/5">
        <div className="p-8">
          <Link to="/" className="flex flex-col">
            ...
            <span className="text-[7px] uppercase tracking-[0.4em] text-white/40">Escritório Digital</span>
          </Link>
        </div>
        ...
        <div className="p-6 border-t border-white/5 space-y-4">
          <Link to="/" className="flex items-center gap-3 px-4 py-3 w-full text-white/60 hover:text-gold transition-colors group border border-white/5 rounded-xl hover:bg-white/5">
          ...
          <Link to="/" className="flex items-center gap-3 px-4 py-3 w-full text-red-400/60 hover:text-red-400 transition-colors group">
          ...
          <div className="flex items-center gap-2 xl:gap-6 ml-3 shrink-0">
            ...
            <div className="flex items-center gap-2 xl:gap-3">
              <div className="hidden xl:block text-right">
                <p className="text-xs font-bold text-velvet uppercase tracking-wider">Dr. Ayrton Pedrosa</p>
                <p className="text-[10px] text-stone-400 font-bold uppercase tracking-tight">OAB/PE 35.952</p>
              </div>
          ...
          {sidebarItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span className={`text-[9px] font-black uppercase tracking-widest text-center transition-all ${isActive ? 'opacity-100' : 'opacity-60'}`}>
                  {item.name}
                </span>
              </Link>
            )
