...
import { Users, Search, Plus, MoreVertical, Mail, Phone, ArrowUpRight, Filter } from "lucide-react";
      ...
      <header className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
        <div className="max-w-xs md:max-w-none">
          ...
          <p className="text-stone-500 text-[10px] sm:text-[11px] md:text-sm mt-1 uppercase tracking-wider font-medium opacity-70">
            Base de relacionamentos estratégica
          </p>
        </div>
      ...
      <div className="xl:hidden space-y-4">
        {clients.map((client, idx) => (
          ...
          >
            ...
            <Button
              variant="ghost"
              className="w-full mt-2 h-10 text-[9px] uppercase tracking-widest font-black text-gold bg-gold/5 hover:bg-gold/10"
            >
              ...
              >
                <td className="px-8 py-5">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm font-bold text-velvet">{client.name}</p>
                      <p className="text-[10px] text-stone-500 font-bold uppercase tracking-tight mt-0.5">
                        Visto em: {client.lastContact}
                      </p>
                    </div>
                  </div>
                </td>
                ...
                <td className="px-8 py-5 text-right">
                  <div className="flex items-center justify-end gap-2">
                    <button
                      className="h-8 w-8 flex items-center justify-center rounded-lg hover:bg-stone-100 text-stone-400 hover:text-gold transition-all"
                      title="Ver Perfil"
                    >
