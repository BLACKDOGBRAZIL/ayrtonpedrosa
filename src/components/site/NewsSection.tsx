...
export function NewsSection() {
  ...
  return (
    <section id="blog" className="relative bg-cream py-28 md:py-32 scroll-mt-28">
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((n) => (
              <div
                key={n}
                className="h-[420px] rounded-none bg-velvet/5 animate-pulse border border-gold/5 flex flex-col justify-end p-10"
              >
