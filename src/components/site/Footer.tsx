      ...
      >
        <div className="md:col-span-5">
          ...
          <p className="mt-8 max-w-sm text-base leading-relaxed text-white/60 font-light">
            Estratégia jurídica especializada para empresas e pessoas que buscam segurança, inovação
            e resultados.
          </p>
        </div>

        <div className="md:col-span-4">
          <h4 className="text-[10px] uppercase tracking-widest text-gold font-medium mb-8">
            Contato Direto
          </h4>
          <motion.ul
            initial="hidden"
          ...
          >
            ...
            >
              ...
              <span className="group-hover:text-white transition-colors text-base font-sans break-words leading-tight">
                contato@ayrtonpedrosa.com
              </span>
            </motion.li>
            <motion.li
              variants={{
        ...
        <div className="md:col-span-3">
          ...
          >
            ...
            <div>
              ...
              <p className="text-lg font-sans text-white group-hover:text-gold transition-colors">
                @ayrtonpedrosa.adv
              </p>
            </div>
          </a>
