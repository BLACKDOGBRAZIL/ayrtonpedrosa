import { d as P, j as Ae } from "./index-0qK1wPb4.js";
const js = P.createContext({});
function Vo(t) {
...
class Qe {
  ...
  add(e) {
    return (Ze(this.subscriptions, e), () => qt(this.subscriptions, e));
  }
  notify(e, n, s) {
...
const Gs = (t, e, n) => (((1 - 3 * n + 3 * e) * t + (3 * n - 6 * e)) * t + 3 * e) * t,
  Eo = 1e-7,
  Ro = 12;
function Lo(t, e, n, s, i) {
  let r,
    o,
    a = 0;
  do ((o = e + (n - e) / 2), (r = Gs(o, s, i) - t), r > 0 ? (n = o) : (e = o));
  while (Math.abs(r) > Eo && ++a < Ro);
  return o;
}
function Ft(t, e, n, s) {
  if (t === e && n === s) return G;
  const i = (r) => Lo(r, 0, 1, t, n);
  return (r) => (r === 0 || r === 1 ? r : Gs(i(r), e, s));
}
const zs = (t) => (e) => (e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2),
  $s = (t) => (e) => 1 - t(1 - e),
  _s = Ft(0.33, 1.53, 0.69, 0.99),
  tn = $s(_s),
  Xs = zs(tn),
  Ys = (t) => (t >= 1 ? 1 : (t *= 2) < 1 ? 0.5 * tn(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1)))),
...
function ti(t, e) {
  ...
  const i = { delta: 0, timestamp: 0, isProcessing: !1 },
    ...
    p = () => {
      const v = st.useManualTiming,
        w = v ? i.timestamp : performance.now();
      ((n = !1),
        v || (i.delta = s ? 1e3 / 60 : Math.max(Math.min(w - i.timestamp, No), 1)),
        (i.timestamp = w),
        (i.isProcessing = !0),
        a.process(i),
        u.process(i),
  ...
  return {
    schedule: jt.reduce((v, w) => {
      const b = o[w];
      return ((v[w] = (R, O = !1, A = !1) => (n || g(), b.schedule(R, O, A))), v);
    }, {}),
    cancel: (v) => {
      for (let w = 0; w < jt.length; w++) o[jt[w]].cancel(v);
    },
    state: i,
    steps: o,
  };
...
const {
  ...
  state: F,
  steps: ue,
} = ti(typeof requestAnimationFrame < "u" ? requestAnimationFrame : G, !0);
let Kt;
function Uo() {
  Kt = void 0;
}
const j = {
    now: () => (
      Kt === void 0 &&
        j.set(F.isProcessing || st.useManualTiming ? F.timestamp : performance.now()),
      Kt
    ),
    set: (t) => {
      ((Kt = t), queueMicrotask(Uo));
    },
  },
  ei = (t) => (e) => typeof e == "string" && e.startsWith(t),
  ni = ei("--"),
  Wo = ei("var(--"),
  nn = (t) => (Wo(t) ? Ko.test(t.split("/*")[0].trim()) : !1),
...
const Go =
  ...
  zo = (t) => Q(0, 255, t),
  ce = { ...wt, transform: (t) => Math.round(zo(t)) },
  ct = {
    test: on("rgb", "red"),
...
const Ve = { test: on("#"), parse: $o, transform: ct.transform },
  It = (t) => ({
  ...
  _o = It("vh"),
  Xo = It("vw"),
  Vn = { ...J, parse: (t) => J.parse(t) / 100, transform: (t) => J.transform(t * 100) },
  gt = {
    test: on("hsl", "hue"),
  ...
  E = {
    test: (t) => ct.test(t) || Ve.test(t) || gt.test(t),
    parse: (t) => (ct.test(t) ? ct.parse(t) : gt.test(t) ? gt.parse(t) : Ve.parse(t)),
    transform: (t) =>
...
function qo(t) {
  return (
    isNaN(t) && typeof t == "string" && (t.match(sn)?.length || 0) + (t.match(Yo)?.length || 0) > 0
  );
}
const ii = "number",
  oi = "color",
...
function Tt(t) {
  ...
  const a = e
    .replace(
      ...
      (u) => (
        E.test(u)
          ? (s.color.push(r), i.push(oi), n.push(E.parse(u)))
          : u.startsWith(Jo)
            ? (s.var.push(r), i.push(Zo), n.push(u))
            : (s.number.push(r), i.push(ii), n.push(parseFloat(u))),
        ++r,
        Cn
      ),
    )
...
function ri({ split: t, types: e }) {
  ...
  return (s) => {
    ...
    for (let r = 0; r < n; r++)
      if (((i += t[r]), s[r] !== void 0)) {
        const o = e[r];
        o === ii ? (i += Vt(s[r])) : o === oi ? (i += E.transform(s[r])) : (i += s[r]);
      }
    return i;
  };
}
...
const nr = (t) => (typeof t == "number" ? 0 : E.test(t) ? E.getAnimatableNone(t) : t),
  sr = (t, e) => (typeof t == "number" ? (e?.trim().endsWith("/") ? t : 0) : nr(t));
function ir(t) {
  const e = Tt(t);
  return ri(e)(e.values.map((s, i) => sr(s, e.split[i])));
}
const _ = { test: qo, parse: tr, createTransformer: er, getAnimatableNone: ir };
function he(t, e, n) {
  return (
    n < 0 && (n += 1),
    n > 1 && (n -= 1),
...
function or({ hue: t, saturation: e, lightness: n, alpha: s }) {
  ...
  if (!e) i = r = o = n;
    ...
    const a = n < 0.5 ? n * (1 + e) : n + e - n * e,
      u = 2 * n - a;
    ((i = he(u, a, t + 1 / 3)), (r = he(u, a, t)), (o = he(u, a, t - 1 / 3)));
  }
  return {
...
const Dn = (t, e) => {
    ...
    const i = { ...n };
    return (r) => (
      (i.red = fe(n.red, s.red, r)),
      (i.green = fe(n.green, s.green, r)),
      (i.blue = fe(n.blue, s.blue, r)),
...
function cr(t, e) {
  const n = { ...t, ...e },
    s = {};
  for (const i in n) t[i] !== void 0 && e[i] !== void 0 && (s[i] = rn(t[i])(t[i], e[i]));
  return (i) => {
...
function yr({
  ...
  let i,
    r,
    o = 1 - e;
  ((o = Q(M.minDamping, M.maxDamping, o)),
    (t = Q(M.minDuration, M.maxDuration, H(t))),
    o < 1
      ? ((i = (c) => {
          const l = c * o,
            h = l * t,
  ...
  const a = 5 / t,
    u = gr(i, r, a);
  if (((t = W(t)), isNaN(u))) return { stiffness: M.stiffness, damping: M.damping, duration: t };
  {
...
function Qt(t = M.visualDuration, e = M.bounce) {
  ...
  if (p < 1)
    ((b = Me(y, p)),
      (R = (m + p * y * g) / b),
      (v = (S) => {
        const D = Math.exp(-p * y * S);
        return o - D * (R * Math.sin(b * S) + g * Math.cos(b * S));
      }),
      (O = p * y * R + g * b),
      (A = p * y * g - R * b),
      (w = (S) => Math.exp(-p * y * S) * (O * Math.sin(b * S) + A * Math.cos(b * S))));
  else if (p === 1) {
    v = (D) => o - Math.exp(-y * D) * (g + (m + y * g) * D);
    const S = m + y * g;
    w = (D) => Math.exp(-y * D) * (y * S * D - m);
  } else {
    const S = y * Math.sqrt(p * p - 1);
    v = (X) => {
      const tt = Math.exp(-p * y * X),
        Y = Math.min(S * X, 300);
      return o - (tt * ((m + p * y * g) * Math.sinh(Y) + S * g * Math.cosh(Y))) / S;
    };
    const D = (m + p * y * g) / S,
      U = p * y * D - g * S,
      rt = p * y * g - D * S;
  ...
  const k = {
    ...
    next: (S) => {
      ...
      if (d) a.done = S >= h;
        ...
        const U = W(w(S));
        a.done = Math.abs(U) <= s && Math.abs(o - D) <= i;
      }
      return ((a.value = a.done ? o : D), a);
    },
    toString: () => {
      const S = Math.min(an(k), Jt),
        D = ui((U) => k.next(S * U).value, S, 30);
      return S + "ms " + D;
    },
    toTransition: () => {},
  };
...
function De({
  ...
  const h = t[0],
    ...
    m = (A) => (a === void 0 ? u : u === void 0 || Math.abs(a - A) < Math.abs(u - A) ? a : u);
  let p = n * e;
  const g = h + p,
    y = o === void 0 ? g : o(g);
  y !== g && (p = y - h);
  const x = (A) => -p * Math.exp(-A / s),
    v = (A) => y + x(A),
    w = (A) => {
      const k = x(A),
        S = v(A);
      ((f.done = Math.abs(k) <= c), (f.value = f.done ? y : S));
    };
  let b, R;
  const O = (A) => {
    d(f.value) &&
  ...
  return (
    O(0),
    {
      ...
      next: (A) => {
        let k = !1;
        return (
          !R && b === void 0 && ((k = !0), w(A), O(A)),
          b !== void 0 && A >= b ? R.next(A - b) : (!k && w(A), f)
        );
      },
    }
  );
...
function Sr(t, e, { clamp: n = !0, ease: s, mixer: i } = {}) {
  const r = t.length;
  if ((Je(r === e.length), r === 1)) return () => e[0];
...
function Ct({ duration: t = 300, keyframes: e, times: n, ease: s = "easeInOut" }) {
  const i = Fo(s) ? s.map(bn) : bn(s),
    r = { done: !1, value: e[0] },
    o = Vr(n && n.length === e.length ? n : Ar(e), t),
    a = Sr(o, e, { ease: Array.isArray(i) ? i : Cr(e, i) });
  return { calculatedDuration: t, next: (u) => ((r.value = a(u)), (r.done = u >= t), r) };
}
const Mr = (t) => t !== null;
function oe(t, { repeat: e, repeatType: n = "loop" }, s, i = 1) {
  const r = t.filter(Mr),
    a = i < 0 || (e && n !== "loop" && e % 2 === 1) ? 0 : r.length - 1;
  return !a || s === void 0 ? r[a] : s;
}
const Dr = { decay: De, inertia: De, tween: Ct, keyframes: Ct, spring: Qt };
function hi(t) {
  typeof t.type == "string" && (t.type = Dr[t.type]);
}
class ln {
  constructor() {
    this.updateFinished();
...
class te extends ln {
  ...
  initAnimation() {
    ...
    u !== Ct &&
      typeof a[0] != "number" &&
      ((this.mixKeyframes = Bt(Er, li(a[0], a[1]))), (a = [0, 100]));
  ...
  tick(e, n = !1) {
    ...
    if (h) {
      ...
      (!S && A >= 1 && (S = 1),
        S === 1 && k--,
        (k = Math.min(k, h + 1)),
        k % 2 && (f === "reverse" ? ((S = 1 - S), d && (S -= d / a)) : f === "mirror" && (w = o)),
        (v = Q(0, 1, S) * a));
    }
    let b;
    (x ? ((this.delayState.value = l[0]), (b = this.delayState)) : (b = w.next(v)),
      r && !x && (b.value = r(b.value)));
    let { done: R } = b;
    !x &&
      u !== null &&
      (R = this.playbackSpeed >= 0 ? this.currentTime >= i : this.currentTime <= 0);
    const O =
      this.holdTime === null && (this.state === "finished" || (this.state === "running" && R));
    return (
      O && m !== De && (b.value = oe(l, this.options, g, this.speed)),
      p && p(b.value),
      O && this.finish(),
      b
    );
  ...
  getGeneratorVelocity() {
    ...
    return ci((s) => this.generator.next(s).value, e, n);
  }
  get speed() {
...
const ht = (t) => (t * 180) / Math.PI,
  ...
  kr = {
    ...
    scaleY: kn,
    scale: (t) => (Ln(t) + kn(t)) / 2,
    rotateX: (t) => Re(ht(Math.atan2(t[6], t[5]))),
    rotateY: (t) => Re(ht(Math.atan2(-t[2], t[0]))),
    rotateZ: Rn,
    rotate: Rn,
...
function fi() {
  ...
  ((Fe = !1), (Be = !1), ft.forEach((t) => t.complete(Ie)), ft.clear());
}
function di() {
  ft.forEach((t) => {
...
class un {
  ...
  scheduleResolve() {
    ((this.state = "scheduled"),
      this.isAsync
        ? (ft.add(this), Be || ((Be = !0), V.read(di), V.resolveKeyframes(fi)))
...
const Kr = pi(() => window.ScrollTimeline !== void 0, "scrollTimeline"),
  gi = pi(() => {
    try {
...
class Ti extends ln {
  constructor(e) {
    ...
    const c = Gr(e);
    ((this.animation = Hr(n, s, i, c, r)),
      c.autoplay === !1 && this.animation.pause(),
      (this.animation.onfinish = () => {
        if (((this.finishedTime = this.time), !r)) {
          const l = oe(i, this.options, a, this.speed);
...
const xi = { anticipate: Ys, backInOut: Xs, circInOut: Zs };
function zr(t) {
  return t in xi;
}
function $r(t) {
  typeof t.ease == "string" && zr(t.ease) && (t.ease = xi[t.ease]);
}
const me = 10;
class _r extends Ti {
  constructor(e) {
...
function Yr(t, e, n, s) {
  ...
  const r = t[t.length - 1],
    o = In(i, e),
    a = In(r, e);
  return !o || !a ? !1 : Xr(t) || ((n === "spring" || vi(n)) && s);
}
function Oe(t) {
...
function Zr(t) {
  for (let e = 0; e < t.length; e++) if (typeof t[e] == "string" && qr.test(t[e])) return !0;
  return !1;
}
const Jr = new Set([
    "color",
  ...
  Qr = Ks(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
function ta(t) {
  const {
    motionValue: e,
    name: n,
...
class na extends ln {
  constructor({
    ...
    const f = {
      ...
      d = l?.KeyframeResolver || un;
    ((this.keyframeResolver = new d(
      a,
      (m, p, g) => this.onKeyframesResolved(m, p, f, !g),
      u,
      c,
      l,
    )),
  ...
  onKeyframesResolved(e, n, s, i) {
    ...
    Yr(e, r, o, a) ||
      ((h = !1),
      (st.instantAnimations || !u) && l?.(oe(e, s, n)),
      (e[0] = e[e.length - 1]),
      Oe(s),
      (s.repeat = 0));
    const d = {
        startTime: i
          ? this.resolvedAt
            ? this.resolvedAt - this.createdAt > ea
              ? this.resolvedAt
              : this.createdAt
            : this.createdAt
          : void 0,
...
function Si(t, e, n = 1) {
  ...
  if (r) {
    const o = r.trim();
    return Ns(o) ? parseFloat(o) : o;
  }
  return nn(i) ? Si(i, e, n + 1) : i;
}
const oa = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
  ...
  aa = { type: "keyframes", duration: 0.8 },
...
function ha(t) {
  for (const e in t) if (!ca.has(e)) return !0;
  return !1;
}
const hn =
  (t, e, n, s = {}, i, r) =>
  (o) => {
    ...
    if (
      ((l.type === !1 || (l.duration === 0 && !l.repeatDelay)) &&
        (Oe(l), l.delay === 0 && (h = !0)),
      (st.instantAnimations || st.skipAnimations || i?.shouldSkipAnimations) &&
        ((h = !0), Oe(l), (l.delay = 0)),
      (l.allowFlatten = !a.type && !a.ease),
      h && !r && e.get() !== void 0)
    ) {
      const f = oe(l.keyframes, a);
      if (f !== void 0) {
        V.update(() => {
    ...
    return a.isSync ? new te(l) : new na(l);
  };
function On(t) {
  const e = [{}, {}];
  return (
...
class da {
  ...
  setCurrent(e) {
    ((this.current = e),
      ...
      this.canTrackVelocity === null && e !== void 0 && (this.canTrackVelocity = fa(this.current)));
  }
...
function Ta({ protectedKeys: t, needsAnimating: e }, n) {
...
function Mi(t, e, { delay: n = 0, transitionOverride: s, type: i } = {}) {
  ...
  for (const f in a) {
    const d = t.getValue(f, t.latestValues[f] ?? null),
      m = a[f];
    if (m === void 0 || (h && Ta(h, f))) continue;
    const p = { delay: n, ...cn(r || {}, f) },
      g = d.get();
    if (g !== void 0 && !d.isAnimating() && !Array.isArray(m) && m === g && !p.velocity) {
      V.update(() => d.set(m));
      continue;
    }
    let y = !1;
    if (window.MotionHandoffAnimation) {
      const w = Ci(t);
      if (w) {
        const b = window.MotionHandoffAnimation(w, f, V);
        b !== null && ((p.startTime = b), (y = !0));
      }
    }
    Ne(t, f);
    const x = c ?? t.shouldReduceMotion;
    d.start(hn(f, d, m, x && Ai.has(f) ? { type: !1 } : p, t, y));
    const v = d.animation;
    v && l.push(v);
  }
  if (o) {
...
function Ue(t, e, n = {}) {
  ...
  const r = s ? () => Promise.all(Mi(t, s, n)) : () => Promise.resolve(),
    o =
  ...
  for (const u of t.variantChildren)
    (u.notify("AnimationStart", e),
      a.push(
        Ue(u, e, {
          ...o,
          delay: n + (typeof s == "function" ? 0 : s) + Pi(t.variantChildren, u, s, i, r),
...
const Pa = { test: (t) => t === "auto", parse: (t) => t },
  Di = (t) => (e) => e.test(t),
  Ei = [wt, T, J, et, Xo, _o, Pa],
  Nn = (t) => Ei.find(Di(t));
function Sa(t) {
  return typeof t == "number" ? t === 0 : t !== null ? t === "none" || t === "0" || Ws(t) : !0;
}
...
function Ra(t, e, n) {
  ...
  for (; s < t.length && !i; ) {
    const r = t[s];
    (typeof r == "string" && !Ea.has(r) && Tt(r).values.length && (i = t[s]), s++);
  }
  if (i && n) for (const r of e) t[r] = Li(n, i);
}
class La extends un {
...
const Bi = (t, e) => (e && typeof t == "number" ? e.transform(t) : t);
function ka(t) {
  return Us(t) && "offsetHeight" in t && !("ownerSVGElement" in t);
}
const { schedule: pn } = ti(queueMicrotask, !1),
  $ = { x: !1, y: !1 };
function Fi() {
  return $.x || $.y;
}
    ...
    s.forEach((o) => {
      ...
      const l = () => {
        ...
        p = (g) => {
          ...
          u = !1;
          const y = e(o, g);
          typeof y == "function" && ((c = y), o.addEventListener("pointerleave", m, i));
        };
...
function ja(t) {
  return Oa.has(t.tagName) || t.isContentEditable === !0;
}
...
function Ka(t, e, n = {}) {
  const [s, i, r] = Ii(t, n),
    o = (a) => {
      ...
      if (!Kn(a) || Hn.has(a)) return;
      (Ht.add(u), n.stopPropagation && Hn.add(a));
      const c = e(u, a),
        l = (d, m) => {
  ...
  return (
    s.forEach((a) => {
      ((n.useGlobalTarget ? window : a).addEventListener("pointerdown", o, i),
        ka(a) &&
          (a.addEventListener("focus", (c) => Wa(c, i)),
          !ja(a) && !a.hasAttribute("tabindex") && (a.tabIndex = 0)));
    }),
    r
  );
}
...
let zt;
const ji = (t, e, n) => (s, i) =>
    i && i[0] ? i[0][t + "Size"] : yn(s) && "getBBox" in s ? s.getBBox()[e] : s[n],
  Ha = ji("inline", "width", "offsetWidth"),
  Ga = ji("block", "height", "offsetHeight");
...
function _a() {
  typeof ResizeObserver > "u" || (zt = new ResizeObserver($a));
}
function Xa(t, e) {
  zt || _a();
  const n = ki(t);
...
function Gn(t, e) {
  return typeof t == "function" ? qa(t) : Xa(t, e);
}
function Za(t) {
...
const vn = ["animate", "whileInView", "whileFocus", "whileHover", "whileTap", "whileDrag", "exit"],
  Tn = ["initial", ...vn];
function ae(t) {
  return re(t.animate) || Tn.some((e) => Lt(t[e]));
}
function Ni(t) {
...
function el(t, e, n) {
  for (const s in e) {
    ...
    else if (I(r)) t.addValue(s, xt(i, { owner: t }));
    else if (r !== i)
      if (t.hasValue(s)) {
...
class ol {
    ...
    ((this.current = e),
      ...
      this.reducedMotionConfig === "never"
        ...
        : this.reducedMotionConfig === "always"
          ...
          : (Ui.current || sl(), (this.shouldReduceMotion = He.current)),
  ...
  getValue(e, n) {
    ...
    return (
      s === void 0 &&
        n !== void 0 &&
        ((s = xt(n === null ? void 0 : n, { owner: this })), this.addValue(e, s)),
      s
    );
  }
  readValue(e, n) {
    ...
    return (
      s != null &&
        (typeof s == "string" && (Ns(s) || Ws(s))
          ? (s = parseFloat(s))
          : !Qa(s) && _.test(n) && (s = Li(e, n)),
...
function ut(t) {
  return Ge(t) || Gi(t) || t.z || t.rotate || t.rotateX || t.rotateY || t.skewX || t.skewY;
}
function Gi(t) {
...
function Yn(t, e, n, s, i) {
  return (i !== void 0 && (t = ne(t, i, s)), ne(t, n, s) + e);
}
...
function ll(t, e, n, s = !1) {
  ...
  (e.x < Zn && e.x > qn && (e.x = 1), e.y < Zn && e.y > qn && (e.y = 1));
}
function Z(t, e) {
  ((t.min += e), (t.max += e));
}
function Jn(t, e, n, s, i = 0.5) {
...
function _t(t, e, n) {
  const s = n ?? t;
  (Jn(t.x, Qn(e.x, s.x), e.scaleX, e.scale, e.originX),
    Jn(t.y, Qn(e.y, s.y), e.scaleY, e.scale, e.originY));
}
function $i(t, e) {
...
function xn(t, e, n) {
  ...
  if (
    (e.transform ||
      (o || n ? (s.transform = fl(e, t.transform, n)) : s.transform && (s.transform = "none")),
    a)
  ) {
...
function Xi(t, { layout: e, layoutId: n }) {
  return (
    St.has(t) || t.startsWith("origin") || ((e || n !== void 0) && (!!$e[t] || t === "opacity"))
  );
}
function wn(t, e, n) {
  const s = t.style,
  ...
  if (!s) return r;
  for (const o in s)
    (I(s[o]) || (i && I(i[o])) || Xi(o, t) || n?.getValue(o)?.liveStyle !== void 0) &&
      (r[o] = s[o]);
  return r;
}
function ml(t) {
...
class pl extends Ki {
  ...
  readValueFromInstance(e, n) {
    if (St.has(n)) return this.projection?.isProjecting ? Le(n) : Br(e, n);
    {
      const s = ml(e),
...
const gl = { offset: "stroke-dashoffset", array: "stroke-dasharray" },
  yl = { offset: "strokeDashoffset", array: "strokeDasharray" };
function vl(t, e, n = 1, s = 0, i = !0) {
  t.pathLength = 1;
  const r = i ? gl : yl;
  ((t[r.offset] = `${-s}`), (t[r.array] = `${e} ${n}`));
}
const Tl = ["offsetDistance", "offsetPath", "offsetRotate", "offsetAnchor"];
function Yi(
  t,
  ...
  for (const d of Tl) h[d] !== void 0 && ((f[d] = h[d]), delete h[d]);
  (e !== void 0 && (h.x = e),
    n !== void 0 && (h.y = n),
    s !== void 0 && (h.scale = s),
    i !== void 0 && vl(h, i, r, o, !1));
}
const qi = new Set([
    "baseFrequency",
    "diffuseConstant",
...
function xl(t, e, n, s) {
  _i(t, e, void 0, s);
  for (const i in e.attrs) t.setAttribute(qi.has(i) ? i : dn(i), e.attrs[i]);
}
function Ji(t, e, n) {
  const s = wn(t, e, n);
  for (const i in t)
...
class wl extends Ki {
  ...
  readValueFromInstance(e, n) {
    ...
    return ((n = qi.has(n) ? n : dn(n)), e.getAttribute(n));
  }
  scrapeMotionValuesFromProps(e, n, s) {
    return Ji(e, n, s);
  }
  ...
  function a(c) {
    ...
    for (let y = 0; y < bl; y++) {
      const x = Sl[y],
        ...
        b = Lt(w),
        R = x === c ? v.isActive : null;
      R === !1 && (p = y);
      let O = w === h[x] && w !== l[x] && b;
      if (
        (O && (s || i) && t.manuallyAnimateOnMount && (O = !1),
        (v.protectedKeys = { ...m }),
        (!v.isActive && R === null) || (!w && !v.prevProp) || re(w) || typeof w == "boolean")
      )
        continue;
      if (x === "exit" && v.isActive && R !== !0) {
        v.prevResolvedValues && (m = { ...m, ...v.prevResolvedValues });
        continue;
      }
      const A = Cl(v.prevProp, w);
      let k = A || (x === c && v.isActive && !O && b) || (y > p && b),
        S = !1;
      const D = Array.isArray(w) ? w : [w];
      let U = D.reduce(r(x), {});
      R === !1 && (U = {});
      const { prevResolvedValues: rt = {} } = v,
        X = { ...rt, ...U },
        tt = (B) => {
          ((k = !0), d.has(B) && ((S = !0), d.delete(B)), (v.needsAnimating[B] = !0));
      ...
      ((v.prevProp = w),
        (v.prevResolvedValues = U),
        v.isActive && (m = { ...m, ...U }),
        (s || i) && t.blockInitialAnimation && (k = !1));
      const Y = O && A;
      k &&
        (!Y || S) &&
        f.push(
          ...D.map((B) => {
            ...
            if (typeof B == "string" && (s || i) && !Y && t.manuallyAnimateOnMount && t.parent) {
              ...
              if (at.enteringChildren && mt) {
                const { delayChildren: Ao } = mt.transition || {};
                K.delay = Pi(at.enteringChildren, t, Ao);
              }
            }
    ...
    if (d.size) {
      ...
      if (typeof l.initial != "boolean") {
        const x = dt(t, Array.isArray(l.initial) ? l.initial[0] : l.initial);
...
function ss(t, e, n, s = 0.5) {
  ((t.origin = s),
    ...
    ((t.scale >= Ml && t.scale <= Dl) || isNaN(t.scale)) && (t.scale = 1),
    ((t.translate >= El && t.translate <= Rl) || isNaN(t.translate)) && (t.translate = 0));
}
function Mt(t, e, n, s) {
...
function kl(t, e, n, s) {
  (is(t.x, e.x, n.x, s?.x), is(t.y, e.y, n.y, s?.y));
}
...
function rs(t, e, n, s, i) {
  return ((t -= e), (t = ne(t, 1 / n, s)), i !== void 0 && (t = ne(t, 1 / i, s)), t);
}
function Bl(t, e = 0, n = 1, s = 0.5, i, r = t, o = t) {
  ...
  (t === r && (a -= e), (t.min = rs(t.min, e, n, a, i)), (t.max = rs(t.max, e, n, a, i)));
}
...
const Fl = ["x", "scaleX", "originX"],
  Il = ["y", "scaleY", "originY"];
function ls(t, e, n, s) {
  (as(t.x, e, Fl, n ? n.x : void 0, s ? s.x : void 0),
    as(t.y, e, Il, n ? n.y : void 0, s ? s.y : void 0));
}
function us(t) {
...
function jl(t, e, n) {
  ...
  if (
    ...
    const { transformPerspective: c, rotate: l, rotateX: h, rotateY: f, skewX: d, skewY: m } = n;
...
const oo = [
  ...
  ps = (t) => typeof t == "number" || T.test(t);
function Ul(t, e, n, s, i, r) {
  i
    ? ((t.opacity = C(0, n.opacity ?? 1, Wl(s))), (t.opacityExit = C(e.opacity ?? 1, 0, Kl(s))))
...
function lo({
  ...
  return class {
    ...
    mount(o) {
      ...
      ((this.isSVG = yn(o) && !Za(o)), (this.instance = o));
          ...
          this.addEventListener(
            ...
            ({ delta: l, hasLayoutChanged: h, hasRelativeLayoutChanged: f, layout: d }) => {
              ...
              const m = this.options.transition || c.getDefaultTransition() || cu,
                { onLayoutAnimationStart: p, onLayoutAnimationComplete: g } = c.getProps(),
              ...
              if (
                ...
                const v = { ...cn(m, "layout"), onPlay: p, onComplete: g };
    ...
    startUpdate() {
      this.isUpdateBlocked() ||
        ((this.isUpdating = !0), this.nodes && this.nodes.forEach(ru), this.animationId++);
    }
    ...
    update() {
      ...
      ((this.animationCommitId = this.animationId),
        ...
        this.clearAllSnapshots());
      const a = j.now();
      ((F.delta = Q(0, 1e3 / 60, a - F.timestamp)),
        (F.timestamp = a),
        (F.isProcessing = !0),
        ue.update.process(F),
        ue.preRender.process(F),
        ue.render.process(F),
        (F.isProcessing = !1));
    }
    didUpdate() {
    ...
    removeTransform(o) {
      ...
      for (let u = 0; u < this.path.length; u++) {
        ...
        let l;
        (c.instance &&
          (Ge(c.latestValues) && c.updateSnapshot(), (l = L()), z(l, c.measurePageBox())),
          ls(a, c.latestValues, c.snapshot?.layoutBox, l));
      }
      return (ut(this.latestValues) && ls(a, this.latestValues), a);
    }
    setTargetDelta(o) {
    ...
    getClosestProjectingParent() {
      if (!(!this.parent || Ge(this.parent.latestValues) || Gi(this.parent.latestValues)))
    ...
    createRelativeTarget(o, a, u) {
      ((this.relativeParent = o),
        ...
        se(this.relativeTargetOrigin, a, u, this.options.layoutAnchor || void 0),
    ...
    calcProjection() {
      ...
      if (
        ...
        this.resolvedRelativeTargetAt === F.timestamp && (u = !1),
        u)
      )
        return;
      ...
      const h = this.treeScale.x,
        f = this.treeScale.y;
      (ll(this.layoutCorrected, this.treeScale, this.path, a),
        o.layout &&
          !o.target &&
          (this.treeScale.x !== 1 || this.treeScale.y !== 1) &&
          ((o.target = o.layout.layoutBox), (o.targetWithTransforms = L())));
      const { target: d } = o;
      if (!d) {
    ...
    setAnimationOrigin(o, a = !1) {
      ...
      const f = L(),
        ...
        x = !!(p && !y && this.options.crossfade === !0 && !this.path.some(uu));
      this.animationProgress = 0;
      let v;
      ((this.mixTargetDelta = (w) => {
        ...
        (xs(h.x, o.x, b),
          ...
          this.relativeTarget &&
            ...
            lu(this.relativeTarget, this.relativeTargetOrigin, f, b),
            v && Ol(this.relativeTarget, v) && (this.isProjectionDirty = !1),
            v || (v = L()),
            z(v, this.relativeTarget)),
          p && ((this.animationValues = l), Ul(l, c, this.latestValues, b, x, y)),
    ...
    finishAnimation() {
      (this.currentAnimation &&
        (this.mixTargetDelta && this.mixTargetDelta(Xl), this.currentAnimation.stop()),
    ...
    registerSharedNode(o, a) {
      (this.sharedNodes.has(o) || this.sharedNodes.set(o, new _l()),
    ...
    resetSkewAndRotation() {
      ...
      if (
        ...
        return;
      const c = {};
      u.z && ve("z", o, c, this.animationValues);
      for (let l = 0; l < ye.length; l++)
        (ve(`rotate${ye[l]}`, o, c, this.animationValues),
          ve(`skew${ye[l]}`, o, c, this.animationValues));
      o.render();
      for (const l in c)
    ...
    applyProjectionStyles(o, a) {
      ...
      let h = jl(this.projectionDeltaWithTransform, this.treeScale, l);
      ...
      for (const m in $e) {
        ...
        const { correct: p, applyTo: g, isCSSVariable: y } = $e[m],
          x = h === "none" ? l[m] : p(l[m], c);
        if (g) {
          const v = g.length;
          for (let w = 0; w < v; w++) o[g[w]] = x;
...
function Zl(t) {
  ...
  if (t.isLead() && t.layout && e && t.hasListeners("didUpdate")) {
    ...
    if (i === "size")
      ...
      const l = i === "x" ? "y" : "x";
      _e(r ? e.measuredBox[l] : e.layoutBox[l], n[l]);
    } else
      uo(i, e.layoutBox, n) &&
        q((l) => {
          const h = r ? e.measuredBox[l] : e.layoutBox[l],
      ...
      if (l && !l.resumeFrom) {
        ...
        if (h && f) {
          const d = t.options.layoutAnchor || void 0,
            m = L();
          se(m, e.layoutBox, h.layoutBox, d);
          const p = L();
          (se(p, n, f.layoutBox, d),
            io(m, p) || (c = !0),
            l.options.layoutRoot &&
              ((t.relativeTarget = p), (t.relativeTargetOrigin = m), (t.relativeParent = l)));
        }
      }
    }
...
function uo(t, e, n) {
  return t === "position" || (t === "preserve-aspect" && !Ll(fs(e), fs(n), 0.2));
}
function fu(t) {
...
function pu() {
  if (Vs) return;
  const t = {};
  for (const e in As) t[e] = { isEnabled: (n) => As[e].some((s) => !!n[s]) };
  (Wi(t), (Vs = !0));
}
function mo() {
  return (pu(), il());
...
let po = (t) => !ie(t);
function vu(t) {
  typeof t == "function" && (po = (e) => (e.startsWith("on") ? !ie(e) : t(e)));
}
try {
  vu(require("@emotion/is-prop-valid").default);
} catch {}
function Tu(t, e, n) {
  const s = {};
  for (const i in t)
...
function wu(t) {
  const { initial: e, animate: n } = xu(t, P.useContext(le));
  return P.useMemo(() => ({ initial: e, animate: n }), [Cs(e), Cs(n)]);
}
function Cs(t) {
...
function go(t, e, n) {
  for (const s in e) !I(e[s]) && !Xi(s, n) && (t[s] = e[s]);
}
...
function Su(t, e) {
  const n = t.style || {},
    s = {};
  return (go(s, n, t), Object.assign(s, Pu(t, e)), s);
}
function bu(t, e) {
  const n = {},
    s = Su(t, e);
...
function Sn(t) {
  return typeof t != "string" || t.includes("-") ? !1 : !!(Vu.indexOf(t) > -1 || /[A-Z]/u.test(t));
}
function Cu(t, e, n, { latestValues: s }, i, r = !1, o) {
  const u = ((o ?? Sn(t)) ? Au : bu)(e, s, i, t),
    c = Tu(e, typeof t == "string", r),
    l = t !== P.Fragment ? { ...c, ...u, ref: n } : {},
    { children: h } = e,
    f = P.useMemo(() => (I(h) ? h.get() : h), [h]);
  return P.createElement(t, { ...l, children: f });
}
function Mu({ scrapeMotionValuesFromProps: t, createRenderState: e }, n, s, i) {
  return { latestValues: Du(n, s, i, t), renderState: e() };
}
function Du(t, e, n, s) {
  const i = {},
    r = s(t, {});
...
const vo = (t) => (e, n) => {
    const s = P.useContext(le),
      i = P.useContext(qe),
      r = () => Mu(t, e, s, i);
    return n ? r() : Vo(r);
  },
  Eu = vo({ scrapeMotionValuesFromProps: wn, createRenderState: Pn }),
  Ru = vo({ scrapeMotionValuesFromProps: Ji, createRenderState: yo }),
...
function Bu(t, e, n, s, i, r) {
  const { visualElement: o } = P.useContext(le),
    a = P.useContext(fo),
    u = P.useContext(qe),
    c = P.useContext(ho),
    l = c.reducedMotion,
  ...
  const m = f.current,
    p = P.useContext(To);
  m && !m.projection && i && (m.type === "html" || m.type === "svg") && Fu(f.current, n, i, p);
  const g = P.useRef(!1);
  P.useInsertionEffect(() => {
    m && g.current && m.update(n, u);
  });
  const y = n[Vi],
    x = P.useRef(
      !!y &&
...
function Fu(t, e, n, s) {
  ...
  ((t.projection = new n(t.latestValues, e["data-framer-portal-id"] ? void 0 : xo(t.parent))),
...
function xo(t) {
  if (t) return t.options.allowProjection !== !1 ? t.projection : xo(t.parent);
}
function xe(t, { forwardMotionProps: e = !1, type: n } = {}, s, i) {
  s && gu(s);
  const r = n ? n === "svg" : Sn(t),
    o = r ? Ru : Eu;
  function a(c, l) {
    let h;
    const f = { ...P.useContext(ho), ...c, layoutId: Iu(c) },
      { isStatic: d } = f,
      m = wu(c),
      p = o(c, d);
    if (!d && typeof window < "u") {
      Ou();
      const g = ju(f);
      ((h = g.MeasureLayout), (m.visualElement = Bu(t, p, f, i, g.ProjectionNode, r)));
    }
    return Ae.jsxs(le.Provider, {
      value: m,
      children: [
        h && m.visualElement ? Ae.jsx(h, { visualElement: m.visualElement, ...f }) : null,
        Cu(t, c, ku(p, m.visualElement, l), p, d, e, r),
      ],
    });
  }
...
function Iu({ layoutId: t }) {
  const e = P.useContext(js).id;
...
function Nu(t, e) {
  if (typeof Proxy > "u") return xe;
  const n = new Map(),
    s = (r, o) => xe(r, o, t, e),
    i = (r, o) => s(r, o);
  return new Proxy(i, {
    get: (r, o) => (o === "create" ? s : (n.has(o) || n.set(o, xe(o, void 0, t, e)), n.get(o))),
  });
}
const Uu = (t, e) =>
  (e.isSVG ?? Sn(t)) ? new wl(e) : new pl(e, { allowProjection: t !== P.Fragment });
class Wu extends ot {
  constructor(e) {
...
class Hu extends ot {
  constructor() {
    (super(...arguments), (this.id = Ku++), (this.isExitComplete = !1));
  }
  update() {
...
const Gu = { animation: { Feature: Wu }, exit: { Feature: Hu } };
function Ot(t) {
  return { point: { x: t.pageX, y: t.pageY } };
}
const zu = (t) => (e) => gn(e) && t(e, Ot(e));
function Dt(t, e, n, s) {
  return kt(t, e, zu(n), s);
}
    ...
    if (
      ...
      (this.updatePoint = () => {
        ...
        const d = we(this.lastMoveEventInfo, this.history),
          ...
          p = $u(d.offset, { x: 0, y: 0 }) >= this.distanceThreshold;
        if (!m && !p) return;
        const { point: g } = d,
          { timestamp: y } = F;
        this.history.push({ ...g, timestamp: y });
        const { onStart: x, onMove: v } = this.handlers;
        (m || (x && x(this.lastMoveEvent, d), (this.startEvent = this.lastMoveEvent)),
          v && v(this.lastMoveEvent, d));
      }),
      (this.handlePointerMove = (d, m) => {
        ((this.lastMoveEvent = d),
          (this.lastRawMoveEventInfo = m),
          (this.lastMoveEventInfo = Ut(m, this.transformPagePoint)),
      ...
      (this.handlePointerUp = (d, m) => {
        ...
        if (
          ...
          return;
        const x = we(
          d.type === "pointercancel" ? this.lastMoveEventInfo : Ut(m, this.transformPagePoint),
          this.history,
        );
...
function we({ point: t }, e) {
  return { point: t, delta: Es(t, So(e)), offset: Es(t, _u(e)), velocity: Xu(e, 0.1) };
}
function _u(t) {
  return t[0];
}
...
function qu(t, { top: e, left: n, bottom: s, right: i }) {
  return { x: Rs(t.x, n, i), y: Rs(t.y, e, s) };
}
function Ls(t, e) {
  let n = e.min - t.min,
    s = e.max - t.max;
...
class nc {
          ...
          q((y) => {
            ...
            if (J.test(x)) {
              ...
              if (v && v.layout) {
                ...
                w && (x = N(w) * (parseFloat(x) / 100));
              }
            }
            this.originPoint[y] = x;
          }),
          p && V.update(() => p(h, f), !1, !0),
  ...
  updateAxis(e, n, s) {
    ...
    (this.constraints && this.constraints[e] && (o = Yu(o, this.constraints[e], this.elastic[e])),
      r.set(o));
  }
  resolveConstraints() {
    ...
    (e && pt(e)
      ...
      : e && s
        ? (this.constraints = qu(s.layoutBox, e))
        : (this.constraints = !1),
      (this.elastic = tc(n)),
      i !== this.constraints &&
        !pt(e) &&
        ...
        q((r) => {
          this.constraints !== !1 &&
            ...
            (this.constraints[r] = Qu(s.layoutBox[r], this.constraints[r]));
        }));
  }
  resolveRefConstraints() {
    ...
    const r = ul(s, i.root, this.visualElement.getTransformPagePoint());
    let o = Zu(i.layout.layoutBox, r);
    if (n) {
      const a = n(rl(o));
  ...
  startAxisValueAnimation(e, n) {
    ...
    return (Ne(this.visualElement, e), s.start(hn(e, s, 0, n, this.visualElement, !1)));
  }
  stopAnimation() {
  ...
  scalePositionWithinConstraints() {
    ...
    q((o) => {
      ...
      if (a && this.constraints !== !1) {
        const u = a.get();
        i[o] = Ju({ min: u, max: u }, this.constraints[o]);
      }
    });
  ...
  addListeners() {
    ...
    const i = () => {
        ...
        pt(c) &&
          ...
          s || (s = sc(e, c.current, () => this.scalePositionWithinConstraints())));
      },
...
const lc = { pan: { Feature: rc }, drag: { Feature: oc, ProjectionNode: co, MeasureLayout: bo } };
function Is(t, e, n) {
  const { props: s } = t;
  t.animationState && s.whileHover && t.animationState.setActive("whileHover", n === "Start");
  const i = "onHover" + n,
    r = s[i];
  r && V.postRender(() => r(e, Ot(e)));
}
class uc extends ot {
  mount() {
    const { current: e } = this.node;
    e &&
      (this.unmount = Ia(e, (n, s) => (Is(this.node, s, "Start"), (i) => Is(this.node, i, "End"))));
  }
  unmount() {}
}
class cc extends ot {
...
class hc extends ot {
  mount() {
    ...
    this.unmount = Ka(
      e,
      (i, r) => (
        Os(this.node, r, "Start"),
        (o, { success: a }) => Os(this.node, o, a ? "End" : "Cancel")
      ),
...
function mc({ root: t, ...e }) {
  ...
  const s = be.get(n),
    i = JSON.stringify(e);
  return (s[i] || (s[i] = new IntersectionObserver(dc, { root: t, ...e })), s[i]);
}
function pc(t, e, n) {
  const s = mc(e);
  return (
...
const Tc = {
  ...
  wc = { ...Gu, ...Tc, ...lc, ...xc },
  Ac = Nu(wc, Uu);
export { js as L, ho as M, qe as P, Mo as a, mu as b, ka as i, Ac as m, Vo as u };
