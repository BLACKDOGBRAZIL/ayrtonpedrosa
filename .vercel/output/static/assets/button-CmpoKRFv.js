import { d as v, j as ae, R as Ue } from "./index-0qK1wPb4.js";
function ye(e, t) {
    ...
    o = v.forwardRef((r, n) => {
      ...
      if (c) {
        ...
        return ae.jsx(t, {
          ...a,
          ref: n,
          children: v.isValidElement(p) ? v.cloneElement(p, void 0, b) : null,
        });
      }
...
var Xe = He("Slot");
function Ze(e) {
  const t = v.forwardRef((o, r) => {
    let { children: n, ...s } = o;
    if ((Ie(n) && typeof K == "function" && (n = K(n._payload)), v.isValidElement(n))) {
      const a = eo(n),
        u = Qe(s, n.props);
      return (n.type !== v.Fragment && (u.ref = r ? Re(r, a) : a), v.cloneElement(n, u));
    }
...
const xe = (e) => (typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e),
  ...
  oo = (e, t) => (o) => {
    var r;
    if (t?.variants == null) return we(e, o?.class, o?.className);
    ...
    return we(e, a, c, o?.class, o?.className);
  },
  ro = (e, t) => {
  ...
  Ee = (e = new Map(), t = null, o) => ({ nextPart: e, validators: t, classGroupId: o }),
  Q = "-",
  ve = [],
  no = "arbitrary..",
  so = (e) => {
  ...
  ho = (e) => {
    ...
    let r = (n) => {
      ...
      g.endsWith(ie)
        ? ((x = g.slice(0, -1)), (R = !0))
        : g.startsWith(ie) && ((x = g.slice(1)), (R = !0));
    ...
    if (t) {
      const n = t + ke,
        s = r;
      r = (a) => (a.startsWith(n) ? s(a.slice(n.length)) : Ce(go, !1, a, void 0, !0));
    }
    if (o) {
      const n = r;
  ...
  xo = (e) => ({ cache: bo(e.cacheSize), parseClassName: ho(e), sortModifiers: yo(e), ...so(e) }),
  wo = /\s+/,
  vo = (e, t) => {
    const {
        parseClassName: o,
  ...
  Do = () => {
    const e = h("color"),
      ...
      d = () => [l, i, c],
      S = () => [j, "full", "auto", ...d()],
      de = () => [E, "none", "subgrid", l, i],
      me = () => ["auto", { span: ["full", E, l, i] }, E, l, i],
      U = () => [E, "auto", l, i],
      ue = () => ["auto", "min", "max", "fr", l, i],
      ee = () => [
        "start",
        "end",
        "center",
      ...
      m = () => [e, l, i],
      pe = () => [..._(), Ae, Se, { position: [l, i] }],
      fe = () => ["no-repeat", { repeat: ["", "x", "y", "space", "round"] }],
      be = () => ["auto", "cover", "contain", Wo, No, { size: [l, i] }],
      te = () => [se, $, O],
      k = () => ["", "none", "full", p, l, i],
      C = () => ["", f, $, O],
    ...
    return {
      ...
      classGroups: {
        ...
        "max-w": [{ "max-w": [u, "screen", "none", "prose", { screen: [a] }, ...N()] }],
        h: [{ h: ["screen", "lh", ...N()] }],
        ...
        "line-clamp": [{ "line-clamp": [f, "none", l, ze] }],
        leading: [{ leading: [s, ...d()] }],
        ...
        "text-decoration-thickness": [{ decoration: [f, "from-font", "auto", l, O] }],
        ...
        "bg-image": [
          {
            bg: [
              "none",
              {
                linear: [{ to: ["t", "tr", "r", "br", "b", "bl", "l", "tl"] }, E, l, i],
                radial: ["", l, i],
                conic: [E, l, i],
              },
              Bo,
        ...
        ease: [{ ease: ["linear", "initial", T, l, i] }],
        delay: [{ delay: [f, l, i] }],
...
const qo = oo(
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
    {
      variants: {
        variant: {
          ...
          hero: "border border-gold text-gold bg-transparent rounded-full hover:bg-gold hover:text-[var(--gold-foreground)] transition-all duration-500 tracking-[0.2em] uppercase text-xs font-medium",
          gold: "bg-gold text-[var(--gold-foreground)] hover:shadow-gold hover:brightness-110 transition-all duration-300 tracking-wide font-medium",
        },
        size: {
  ...
  Ho = v.forwardRef(({ className: e, variant: t, size: o, asChild: r = !1, ...n }, s) => {
    const a = r ? Xe : "button";
    return ae.jsx(a, { className: Yo(qo({ variant: t, size: o, className: e })), ref: s, ...n });
  });
Ho.displayName = "Button";
export { Ho as B, Re as a, He as b, Yo as c, oo as d, Zo as u };
